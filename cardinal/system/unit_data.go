...
var UnitRegistry = map[string]UnitType{
	"Vampire":    {Class: "melee", Health: 100, Damage: 0, AttackRate: 10, DamageFrame: 4, Speed: 50, Cost: 50, Radius: 80, AggroRadius: 1400, AttackRadius: 10},
	"ArcherLady": {Class: "range", Health: 75, Damage: 0, AttackRate: 30, DamageFrame: 20, Speed: 0, Cost: 50, Radius: 50, AggroRadius: 1400, AttackRadius: 1200},
}
